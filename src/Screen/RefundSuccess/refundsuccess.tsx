...
const Refundsuccess: React.FC<any> = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.safeareaview}>
            ...
            <View style={styles.view}>
                ...
                <Button onPress={()=> navigation.navigate('refundhistory')} text={'Done'} color={'#FFFFFF'} backgroundColor={'#4AB5E3'} fontSize={15} height={50} width={'100%'} borderWidth={1} marginTop={50} />
