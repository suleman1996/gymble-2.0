...
import {CrossIcon, NotactiveIcon, ActiveIcon} from '../../Home/Svgs/Icons';
import PickerButton from '../../../Components/Button/pickerButton';

const AddSubFacilityImageScreen: React.FC<any> = ({navigation}) => {
...
export default AddSubFacilityImageScreen;
