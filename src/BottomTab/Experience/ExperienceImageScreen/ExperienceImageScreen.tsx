...
import {ImageLaoutIcon, UploadIcon} from './SVG/Icon';
import {CrossIcon} from '../../Home/Svgs/Icons';
import PickerButton from '../../../Components/Button/pickerButton';

const ExperienceImageScreen: React.FC<any> = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.view1}>
        ...
        />
        <Text style={styles.text}>Experience Images</Text>
      ...
      <ScrollView>
        ...
        <View style={styles.main3View}>
          <View style={styles.ImageBox}>
            {image1 === '' ? (
              <ImageLaoutIcon style={styles.dotsIcon} />
            ) : (
              <>
                <Image source={{uri: image1}} style={styles.images} />
              </>
            )}
          </View>
          <View style={styles.ImageBox}>
            {image2 === '' ? (
              ...
              <>
                <Image source={{uri: image2}} style={styles.images} />
              </>
            )}
          </View>
          <View style={styles.ImageBox}>
            {image3 === '' ? (
              ...
              <>
                <Image source={{uri: image3}} style={styles.images} />
              </>
            )}
          </View>
        </View>
      ...
      <View style={styles.endBtn}>
        <PickerButton
          ...
          borderColor="#9BA2AE"
          marginBottom={10}
          onPress={() => navigation.navigate('experienceWorkOut')}
        />
        <PickerButton
          text={'Continue'}
          color={'#fff'}
...
export default ExperienceImageScreen;
