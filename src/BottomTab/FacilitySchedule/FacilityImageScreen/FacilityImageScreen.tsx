...
const FacilityImageScreen: React.FC<any> = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.view1}>
        ...
        />
        <Text style={styles.text}>Facility Images</Text>
      ...
      <View style={styles.endBtn}>
        <PickerButton
          ...
          borderColor="#9BA2AE"
          marginBottom={10}
          onPress={() => navigation.navigate('facilityWorkOut')}
        />
        <PickerButton
          text={'Continue'}
          color={'#fff'}
...
export default FacilityImageScreen;
