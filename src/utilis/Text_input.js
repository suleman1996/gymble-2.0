...
const FormInput = (data) => {
    let { error, rightIconName, containerStyle, onPressIcon, forgetPassword, forget, textInputContainerStyle, title, predefineContainer, predefineTextStyle, RightIconFamily, iconColorRight, selectable, leftChild,rightChild } = data
    return (
